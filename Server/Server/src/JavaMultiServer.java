...
class JavaMultiServer {
	public static void main(String[] args) throws IOException {
		...
		try (ServerSocket serverSocket = new ServerSocket(portNumber)) {
			 ...
			 *
			 * pins[1] = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_01,
			 * "MyLED", PinState.HIGH); pins[2] =
			 * gpio.provisionDigitalOutputPin(RaspiPin.GPIO_02, "MyLED",
			 * PinState.HIGH);
			 */
...
class ServerThread extends Thread {
	...
	public void run() {
		...
		try (PrintWriter printWriter = new PrintWriter(this.socket.getOutputStream(), true);
			...
			printWriter.println("Hello from Raspb");
